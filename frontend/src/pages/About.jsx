...
export default function About() {
    ...
    return (
        <div className="min-h-screen bg-[#f8f9ff] dark:bg-[#121212] flex flex-col">
            ...
            {/* About Content*/}
            <main className="flex-grow flex items-center justify-center p-6 bg-[#f8f9ff] dark:bg-[#121212] transition-colors duration-300">
                <div className="bg-white dark:bg-[#1a1a1a] rounded-[40px] shadow-xl p-12 max-w-5xl w-full border border-gray-100 dark:border-gray-800 transition-all">
                    <h1 className="text-[42px] font-extrabold text-[#1a1a1a] dark:text-white text-center mb-6">About CookMate</h1>

                    <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed text-center max-w-3xl mx-auto mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Community Card */}
                        <div className="bg-[#fff9f4] dark:bg-[#2a2a2a] p-8 rounded-[32px] border border-orange-50 dark:border-gray-800 flex flex-col items-center text-center transition-colors">
                        ...
                        <div className="bg-[#fff9f4] dark:bg-[#2a2a2a] p-8 rounded-[32px] border border-orange-50 dark:border-gray-800 flex flex-col items-center text-center transition-colors">
                            ...
                            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Quality</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                        ...
                        <div className="bg-[#fff9f4] dark:bg-[#2a2a2a] p-8 rounded-[32px] border border-orange-50 dark:border-gray-800 flex flex-col items-center text-center transition-colors">
                            ...
                            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Smart Help</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
